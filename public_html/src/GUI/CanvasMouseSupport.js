...
CanvasMouseSupport.prototype.toPointer = function () {
    this.canvas.style.cursor = "pointer";
};

CanvasMouseSupport.prototype.toDefault = function () {
    this.canvas.style.cursor = "default";
};

var CanvasMouse = null; // it might get initialized in MainController